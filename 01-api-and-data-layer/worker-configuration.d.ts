...
interface __BaseEnv_Env {
	...
	ADMIN_KEY: string;
	// DraftManager/DraftServer classes live in 03-realtime-draft-engine/ in this showcase repo
	DRAFT_MANAGER: DurableObjectNamespace;
	DRAFT_SERVER: DurableObjectNamespace<import("./lib/draft-do-stubs").DraftServerStub>;
}
