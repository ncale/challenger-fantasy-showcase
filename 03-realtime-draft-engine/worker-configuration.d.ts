/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c50a756663beb5f3d4c10665c22290a6)
// Runtime types generated with workerd@1.20260630.1 2025-08-05 nodejs_compat
interface __BaseEnv_Env {
	// STUBBED: originally literal string types pinned to the real Supabase project ref
	...
	ADMIN_KEY: string;
	DRAFT_MANAGER: DurableObjectNamespace<import("./durable-objects/draft-manager").DraftManager>;
	DRAFT_SERVER: DurableObjectNamespace<import("./durable-objects/draft-server").DraftServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./durable-objects/draft-manager");
		durableNamespaces: "DraftManager" | "DraftServer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_PROJECT_ID" | "SUPABASE_URL" | "LOG_LEVEL" | "PRETTY_LOGS" | "SUPABASE_SERVICE_ROLE_KEY" | "ADMIN_KEY">> {}
}
