...
interface __BaseEnv_Env {
	SUPABASE_PROJECT_ID: "asqybhgaovcdrjxsnoej";
	SUPABASE_URL: "https://asqybhgaovcdrjxsnoej.supabase.co";
	LOG_LEVEL: "info";
	PRETTY_LOGS: "false";
	SUPABASE_SERVICE_ROLE_KEY: string;
	ADMIN_KEY: string;
	DRAFT_MANAGER: DurableObjectNamespace<import("./src/index").DraftManager>;
	DRAFT_SERVER: DurableObjectNamespace<import("./src/index").DraftServer>;
}
