import { PG_ERROR_CODES } from "@challenger-fantasy/core";
import { getGameName, mapFightToDto } from "@challenger-fantasy/models";
import type { EventCardDto, EventWithGamesDto } from "@challenger-fantasy/schemas";
