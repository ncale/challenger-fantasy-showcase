import { lookupFighterId, upsertFighterStats } from "@challenger-fantasy/db";
import {
  createRedisClient,
  type JobData,
  JobRole,
...
import { type FighterStatsInsert, FighterStatsInsertSchema } from "@challenger-fantasy/schemas";
