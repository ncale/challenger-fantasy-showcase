import { UFC } from "@challenger-fantasy/core";
import { upsertEvent } from "@challenger-fantasy/db";
import {
  createRedisClient,
  type JobData,
  JobRole,
...
import { type EventInsert, EventInsertSchema } from "@challenger-fantasy/schemas";
