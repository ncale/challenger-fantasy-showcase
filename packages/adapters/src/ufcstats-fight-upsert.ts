import { getRoundsScheduled, toWeightClassKey } from "@challenger-fantasy/core";
import { lookupEventId, lookupFighterId, upsertFight } from "@challenger-fantasy/db";
import {
  createQueue,
  createRedisClient,
  type JobData,
...
import { type FightInsert, FightInsertSchema } from "@challenger-fantasy/schemas";
import { slugifyFight } from "@challenger-fantasy/utils";
