...
import { Discord } from "~/components/social-icons/discord-icon";
import { Instagram } from "~/components/social-icons/instagram-icon";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-36 pt-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-0.5">
            <HeaderLogo size="sm" />
            <p className="text-sm mt-3">{SITE_CONTENT.FOOTER.COPYRIGHT_TEXT}</p>
