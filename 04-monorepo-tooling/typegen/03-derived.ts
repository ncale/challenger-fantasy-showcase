// Step 3: hand-written, ergonomic types layered on top of the generated
// `Database` type — this is what the rest of the codebase actually imports
// (see e.g. 01-api-and-data-layer/types/derived.ts, copied here unchanged).
import type { SupabaseClient } from "@supabase/supabase-js";
import type { Database } from "./04-generated-overwrite";
